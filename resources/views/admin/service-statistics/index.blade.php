...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin.service-statistics.create') }}" class="btn btn-primary">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-success">{{ $statistic->year }}</span></td>
                        <td>{{ $statistic->category }}</td>
                        <td><strong>{{ $statistic->count }}</strong></td>
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('admin.service-statistics.edit', $statistic->id) }}"
                                   class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="{{ route('admin.service-statistics.destroy', $statistic->id) }}"
...
<div class="row mt-4">
    ...
    <div class="col-md-4">
        <div class="card bg-primary text-white">
            <div class="card-body">
                <h5 class="card-title">Total Pengabdian</h5>
                <h2>{{ App\Models\ServiceStatistic::sum('count') }}</h2>
            </div>
        </div>
    </div>
    <div class="col-md-4">
