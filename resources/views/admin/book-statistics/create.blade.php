...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin.book-statistics.index') }}" class="btn btn-secondary">
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.book-statistics.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('category') is-invalid @enderror"
                       ...
                       placeholder="Contoh: Referensi, Monograf, Textbook, Ajar" required>
                @error('category')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <div class="form-text">Masukkan kategori buku</div>
            </div>
