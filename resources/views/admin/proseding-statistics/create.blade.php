...
@section('title', 'Tambah Data Proseding')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Tambah Data Proseding</h2>
    <a href="{{ route('admin.proseding-statistics.index') }}" class="btn btn-secondary">
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.proseding-statistics.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('category') is-invalid @enderror"
                       ...
                       placeholder="Contoh: Nasional, Internasional, Lokal" required>
                @error('category')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <div class="form-text">Masukkan kategori proseding</div>
            </div>
