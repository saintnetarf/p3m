...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin.publication-statistics.create') }}" class="btn btn-primary">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-info">{{ $statistic->year }}</span></td>
                        <td>{{ $statistic->category }}</td>
                        <td><strong>{{ $statistic->count }}</strong></td>
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('admin.publication-statistics.edit', $statistic->id) }}"
                                   class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="{{ route('admin.publication-statistics.destroy', $statistic->id) }}"
    ...
    <div class="col-md-4">
        <div class="card bg-primary text-white">
            <div class="card-body">
                ...
                <h2>{{ App\Models\PublicationStatistic::sum('count') }}</h2>
            </div>
        </div>
    </div>
    <div class="col-md-4">
