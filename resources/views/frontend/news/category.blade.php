    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <p class="lead">{{ $category->description ?? 'Berita kategori ' . $category->name }}</p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <div class="alert alert-info text-center py-5">
                        ...
                        <p class="mt-3 mb-0">Belum ada berita di kategori ini</p>
                    </div>
                </div>
                @endforelse
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('news.category', $cat->slug) }}"
                           class="list-group-item list-group-item-action d-flex justify-content-between align-items-center border-0 px-0 {{ $cat->id == $category->id ? 'active' : '' }}">
                            {{ $cat->name }}
                            <span class="badge {{ $cat->id == $category->id ? 'bg-light text-dark' : 'bg-primary' }} rounded-pill">{{ $cat->news_count }}</span>
                        </a>
                        @endforeach
                    </div>
                </div>
